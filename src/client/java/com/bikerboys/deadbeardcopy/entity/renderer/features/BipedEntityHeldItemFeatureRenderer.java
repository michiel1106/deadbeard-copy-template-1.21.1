...
public class BipedEntityHeldItemFeatureRenderer<T extends LivingEntity & GeoAnimatable> extends BlockAndItemGeoLayer<T> {

    public BipedEntityHeldItemFeatureRenderer(GeoRenderer<T> renderer) {
        super(renderer);
    }
